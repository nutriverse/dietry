...
reliable results. This is the main motivation of the `dietry` package.

The dietry package provides/will be providing function sets for the
following dietary intake indicators:
...
The package also includes/will include non-diet specific but food
security-related indicators that are commonly assessed alongside dietary
intake indicators in a food security assessment. These are:
